...
export default function Home() {
  ...
  const categorias = ['Todas', ...new Set(noticias.noticias.map(n => n.categoria))];
  
  const noticiasFiltradas = categoriaAtiva === 'Todas' 
    ? noticias.noticias 
    : noticias.noticias.filter(n => n.categoria === categoriaAtiva);

  const noticiasDestaque = noticias.noticias.filter(n => n.destaque);
          ...
          <div className="grid md:grid-cols-4 gap-12 mb-12">
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-400">
                ...
                <li><a href="#" className="hover:text-white transition-colors">Tendências</a></li>
